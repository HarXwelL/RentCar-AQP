        ...
        <div class="ava">
            <div class="container-fluid m-10 pb-5" style="background-color:#E7E8EA">
                ...
                <div class="row">
                    <div class="col">
                        <br>
                        <h4>La empresa RentarCar provee el servicio de alquiler de coches donde se podrá alquilar distintos autos, se podrá ver y escoger entre distintos modelos, también se mostrará la descripción de cada auto, además que el registro de la página será rápido y sencillo, el cual ayudará a cada cliente, y también el cliente podrá tener acceso a ciertas ofertas especiales.</h4>
                    </div>  
                    <div class="col">
