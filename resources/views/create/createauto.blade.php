...
@section('content')
    ...
    @csrf
      ...
      <div class="input-group mb-3">
        ...
        <input id="color" name="color" type="text" class="form-control"  placeholder="color" aria-label="color" aria-describedby ="basic-addon1">
      </div> 
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">{{ __('Capacity') }}</span>
        </div>
        <input id="capacity" name="capacity" type="text" class="form-control"  placeholder="capacity" aria-label="capacity" aria-describedby ="basic-addon1">
      </div> 
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">{{ __('Plate no') }}</span>
        </div>
        <input id="plate_no" name="plate_no" type="text" class="form-control"  placeholder="plate_no" aria-label="plate_no" aria-describedby ="basic-addon1">
      </div>
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">{{ __('Price') }}</span>
        </div>
        <input id="price" name="price" type="text" class="form-control"  placeholder="price" aria-label="price" aria-describedby ="basic-addon1">
      </div>
        <button type="submit" class="float-right btn btn-success">{{ __('Add') }}</button>
        <button class="float-right btn btn-info">{{ __('Report') }}</button>
    </form>
        <a href="/auto" class="float-right btn btn-primary">{{ __('Cancel') }}</a>
@stop
